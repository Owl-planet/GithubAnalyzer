<template>
    <div>
        ...
        <span class="ml-5 mt-2">2. User : <span style="color:green;">{{isReadySU}}</span></span> <input class="input-group-text ml-5 mt-2" v-model.lazy="secondUser" style="background-color:black;color:white;" type="text">
