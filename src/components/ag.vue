<template>
    <div>
        <button v-if="isReadySU == 'Ready'" class="btn btn-success ml-5 mt-5 mb-5" @click="getChart">2. Run</button>
        <button v-else class="btn btn-success ml-5 mt-5 mb-5" @click="getUserInfo">1. Get User Infos</button><br>
